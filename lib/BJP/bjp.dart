...
import 'bjpSearch.dart';

class BjpPage extends StatefulWidget {
  const BjpPage({super.key});

  static const String routeName = '/bjp-page';

  @override
  State<BjpPage> createState() => _BjpPageState();
}

class _BjpPageState extends State<BjpPage> {
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                    onPressed: () {
                      showSearch(context: context, delegate: BjpSearchUser());
                    },
