import 'dart:convert';
import 'package:data_app/OtherData/SPG/spgSearch.dart';
...
class SpgPage extends StatefulWidget {
  const SpgPage({super.key});

  static const String routeName = '/Spg-page';

  @override
  State<SpgPage> createState() => _SpgPageState();
}

class _SpgPageState extends State<SpgPage> {
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                    onPressed: () {
                      showSearch(context: context, delegate: SpgSearchUser());
                    },
